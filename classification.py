...
B = 15
total = N*K*B
manncell = MANNCell(rnn_size_list = [512,256,128],FC_layer_list=[128,84], memory_size = 20,memory_vector_dim = 8,head_num =4)
...
with tf.Session() as sess:  
    ...
    history = model.fit_generator(data_generator.sample_batch('train',B),epochs=40000,steps_per_epoch=50,validation_data = data_generator.sample_batch('val',B),validation_steps = B)
